var ChatClient = angular.module('ChatClient', ['ngRoute', 'ngAnimate', 'toastr']);;angular.module("ChatClient").config(['$routeProvider',
...
angular.module("ChatClient").factory('socket', ['$rootScope',
 function ($rootScope) {
